...
The range of weights in the dataset is  0.2298 and 3.0386. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
The respondent with the weight of 0.23 is overrepresented in the sample, so their response is scaled down versus the respondent with the weight of 3.04 is underrepresented in the sample, so their response is scaled up.
 

3. Why might some respondents be weighted more heavily than others?
Some respondents may be weighed more heavily than others because they are underrepresented in the survey. Weighing helps create results that are better reflective of a population. 
...
The rarely/never voter category shows the biggest difference. It has the largest shifts across responses including a -3.6 percentage point change for Yes. 

2. How might these differences affect reporting on likely voter turnout?
If the data is not weighted, it may overestimate participation from certain groups and underestimate other groups. So, weighting helps adjust the turnout estimates making the reporting more reflective of the population.  
...
These differences likely exist because some groups are either overrepresented or underrepresented in the sample. The  adjustments for the rarely/never group show they most likely have been overrepresented.
