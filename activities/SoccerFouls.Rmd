...
The correlation between soccer fouls and the number of goals made is 0.018, which is not high, so the number of soccer fouls don't really look like they matter. Same for the line, it is pretty flat, giving no correlation. 
...
```
The correlation between the shots on goal and number of goals is positively correlated. Therefore, the highest of shots on goals, the higher the number of goals the team will score.  
