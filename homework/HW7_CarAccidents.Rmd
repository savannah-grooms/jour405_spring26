...
While looking at the graph, I noticed a severe dip in accidents in Prince George's County for 2020,then a rebound later. In addition, around the start of every year around late Dec. to early January in multiple years the data took a little dip. A few questions I had was, do major spikes correspond with snow/icy weather days? What is the explanation behind the dips around New Years? How does injures/ how serve the accidents are play a role in this? A few potential story angles include how did the roads/accident rate change during 2020, did these things stay after the pandemic? With the holiday slowdown data shows safer roads around the Holiday season.
...
The day-of-the-week analysis shows that Friday and Saturday have the highest average accidents and it appears that Monday and the rest of the week days have lower. This pattern is probably the case due to work. People normally go straight to work and come home on week days while some might go out on weekends. This is reflective of increase in speeding or trips after going out. 
...
The date which had the most accidents was Oct. 29, 2021. While I was researching this date, I stumbled across this news article, published by dcist, https://dcist.com/story/21/10/29/dc-maryland-virginia-coastal-flooding-warning-oct-29-30/, which says that the DMV experienced the worst tidal flooding in years. Halloween is also around this time. I think that when reporting on events such as flooding we should incorporate how accidents can be a major problem in an event like this. 
...
When we compare extreme z-scores overall we are comparing the accident rate across the board versus when we compare extreme day-of-the-week z-scores we are comparing the z-scores to only the rest of that specific day of the week. The day-of-the-week list breaks that pattern of mostly Saturdays and Fridays. It flagged weekdays which before were very slow and didn't rank on the z-score list. From a journalistic standpoint, I would approach the this differently. With the overall z-scores I would question why the pattern. And look at it through a system of occurrence. On the day-of-the-week z-score I would question specific days. What major holiday or severe weather could cause a peak in accidents?
...
Based on the monthly pattern analysis, the data has a peak in Feb., May and October. The highest overall season for accidents is September through December while Jan has the lowest average accidents. I believe that October may have just had bad weather. The late-year increases in accidents can be contributed to the days getting darker faster and the colder weather coming in. October is also homecoming season for various colleges and highschools so students may be out partying causing accidents. 
...
For the extreme outliers, they all occur on either a Friday or a Saturday. The end of a week. 
...
Fall Season Brings Higher Crash Rates in Prince George's County: Here’s How Drivers Can Stay Safe

As the daylight fades earlier and the roads grow busier, recent data shows a clear seasonal trend: accidents rise sharply as the county approaches fall, with the highest average occurring in October. While weekends bring more crashes, several fall days stand out as unusually dangerous compared to normal traffic patterns. 

Here are a few tips from experts on how to stay safe during the peak of accidents. 
...
Maryland Accident Reconstruction Expert Witnesses
Accident & Safety Consultants
https://www.jurispro.com/category/accident-reconstruction-s-4/MD
