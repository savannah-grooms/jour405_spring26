...
With a 0.95n, there is a strong positive correlation between the DJIA and GDP. The scatterplot shows that the points are pretty much centered around the line of best fit with has a postitve slope. This means that as the DJIA increases, GDP also tends to increase. The points do not appear widely scattered, meaning a strong relationship between the two variables
